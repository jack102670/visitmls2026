...
export default {
  ...
  const pageWidth = doc.internal.pageSize.getWidth();
  const txtWidth = doc.getStringUnitWidth(text) * doc.internal.getFontSize() / doc.internal.scaleFactor;
  ...
  doc.setFont(undefined, "normal");
      ...
      addSectionHeading2("Permit To Work");

doc.setFontSize(9);
doc.setFont(undefined, "bold");
doc.text("Form No:", 152, 12);
doc.text("Rev:", 152, 15);
doc.text("Effective Date:", 152, 18);
doc.text("Serial No:", 152, 21);

doc.setFont(undefined, "normal");
doc.text("PKT-SF03", 178, 12);
doc.text("03", 178, 15);
doc.setFontSize(9);
doc.text("17", 178, 18);
doc.setFontSize(7);
doc.text("th", 182, 17.5);
doc.setFontSize(9);
doc.text("October 2022", 185, 18);
doc.text(this.ptwData.refNumber, 178, 21);

// Draw a rectangle around the text
doc.rect(150, 8, 55, 15);

// Draw a vertical line to separate the labels from the values
doc.line(177, 8, 177, 23);
...
doc.addImage(base64Img, "JPEG", 15, 7, 20, 20);
    ...
    doc.setFontSize(9);
doc.setFont(undefined, "bold");
doc.text("Form No:", 152, 4 + yPos - 5);
doc.text("Rev:", 152, 7 + yPos - 5);
doc.text("Effective Date:", 152, 10 + yPos - 5);

doc.setFont(undefined, "normal");
doc.text("PKT-SF12", 178, 4 + yPos - 5);
doc.text("01", 178, 7 + yPos - 5);
doc.setFontSize(9);
doc.text("13", 178, 10 + yPos - 5);
doc.setFontSize(7);
doc.text("th", 182, 9.5 + yPos - 5);
doc.setFontSize(9);
doc.text("Sept 2021", 185, 10 + yPos - 5);

// Draw a rectangle around the text
doc.rect(150, 0 + yPos - 5, 55, 12);

// Draw a vertical line to separate the labels from the values
doc.line(177, 0 + yPos - 5, 177, 12 + yPos - 5);


yPos += 5; // Move down by 10 units
  ...
  const jobDescriptionInfo = [
      ...
      // Jobs Hazard Analysis
      addSectionHeading("Jobs Hazard Analysis Worksheet");
...
doc.setFont(undefined, "normal");
doc.text("PKT-SF13", 178, 4 + yPos - 5);
doc.text("00", 178, 7 + yPos - 5);
doc.setFontSize(9);
doc.text("22", 178, 10 + yPos - 5);
doc.setFontSize(7);
doc.text("th", 182, 9.5 + yPos - 5);
doc.setFontSize(9);
doc.text("October 2022", 185, 10 + yPos - 5);
...
yPos += 5; // Move down by 10 units
      ...
      if (this.ptwData.hotWork.workDescription != null) {
        addSectionHeading("Hot Work Permit");
...
doc.setFont(undefined, "normal");
doc.text("PKT-SF14", 178, 4 + yPos - 5);
doc.text("00", 178, 7 + yPos - 5);
doc.setFontSize(9);
doc.text("17", 178, 10 + yPos - 5);
doc.setFontSize(7);
doc.text("th", 182, 9.5 + yPos - 5);
doc.setFontSize(9);
doc.text("May 2022", 185, 10 + yPos - 5);
...
yPos += 5; // Move down by 10 units
      ...
      if (this.ptwData.wah.companyName != null) {
        addSectionHeading("Work at Height Permit");
