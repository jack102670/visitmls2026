<template>
    <div class="w-full h-screen flex flex-col items-center justify-center overflow-hidden bg-animation">
      ...
      <div class="flex flex-col items-center justify-center">
          ...
          <p class="md:text-lg xl:text-xl text-gray-500 mt-4">Sorry, the page you are looking for does not exist.</p>
      </div>
  </div>
  </template>
  ...
  .bg-animation::before {
    ...
    animation: move-circle1 10s infinite;
  }
  
  .bg-animation::after {
    background: radial-gradient(circle, rgba(0, 255, 255, 0.3), transparent);
    animation: move-circle2 15s infinite;
  }
  
  .dark .bg-animation::before {
    background: radial-gradient(circle, rgba(0, 0, 255, 0.5), transparent);
  }
  
  .dark .bg-animation::after {
    background: radial-gradient(circle, rgba(0, 255, 255, 0.3), transparent);
  }
  </style>
