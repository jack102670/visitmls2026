      ...
      <div id="summaryPrint"
          ...
          <div class="details" v-show="seeMore">
            <div v-for="(detail, i) in claimDatasDetails" :key="i" class="detail-table mt-5">
              ...
              <div class="border rounded-md border-gray-400 dark:border-gray-600 overflow-y-auto">
                <table class="w-full table-auto divide-y divide-gray-200 dark:divide-gray-700 hover stripe border border-gray-200 dark:border-gray-700 md:rounded-lg">
              ...
              <th class="text-xs text-center font-semibold border-r border-gray-400 dark:border-gray-600">
                <div
                  ...
                  :class="{
                    ...
                    'bg-amber-100/60 dark:bg-gray-800': simplifiedFinanceStatus === 'RESUBMITTED',
                  ...
                  <span :class="{
                    ...
                    'bg-amber-500': simplifiedFinanceStatus === 'RESUBMITTED',
                  ...
                  <span :class="{
                    ...
                    'text-amber-500': simplifiedFinanceStatus === 'RESUBMITTED',
        ...
        <div v-show="showFileList"
          ...
          <div class="bg-white dark:bg-gray-700 w-full max-w-3xl mx-4 shadow-xl relative">
            ...
            <div v-if="files.length > 0" class="overflow-x-auto p-2 p-4 w-full max-w-3xl max-h-[80vh] overflow-y-auto">
        ...
        try {
          ...
          for (let i in result) {
            ...
            const editedDetail = {
              ...
              'Fuel/EV (RM)': Number(result[i].total_mileage).toFixed(2),
   ...
   this.showOemList = true;
    ...
    async ApproveOrReject(AoR) {
     ...
     //   console.log(approveData);
        ...
        const response = await axios.put('http://172.28.28.116:6165/api/Admin/Approve_Claim', approveData);
        ...
        await axios
          .put('http://172.28.28.116:6165/api/Admin/Approve_Claim', approveData)
          .then((response) => {
            this.loading = false;
      ...
      if (Array.isArray(val)) {
        ...
        axios
          ...
          .then((response) => {
            ...
            console.log("Image URLs from backend:", this.files); // This is where it belongs
            this.showFileList = true;
          })
          .catch((error) => {
