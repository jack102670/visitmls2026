      ...
      <div id="summaryPrint"
        ...
        <div>
          ...
          <div class="flex space-x-2 py-2">
            <div v-if="simplifiedCheckerStatus === 'PENDING'" 
    ...
    async ApproveOrReject(AoR) {
      ...
      if (AoR === 'Check') {
        try {
          ...
          const response = await axios.put(' http://172.28.28.116:6165/api/Admin/Check_Claim', {
            ...feedbackData,
            admin_status: 'CHECKED BY CHECKER. WAITING FOR VERIFIER',
          });
        ...
        try {
          await axios.put(' http://172.28.28.116:6165/api/Admin/Check_Claim', {
            ...feedbackData,
            admin_status: 'REJECTED BY CHECKER',
          });
