      ...
      <section class="max-w-4xl p-6 mx-auto bg-white rounded-md shadow-md dark:bg-gray-800">
        ...
        <form>
          ...
          <div class="grid grid-cols-1 pt-4 gap-6 mt-4 sm:grid-cols-2">
            ...
            <div>
              <label class="text-gray-700 dark:text-gray-200">
                <input type="checkbox" value="OthersPPE" v-model="equipment" />
                Others
              </label>
            </div>
          </div>
          ...
          <div class="grid grid-cols-1 pt-4 gap-6 mt-4 sm:grid-cols-2">
            ...
            <div>
              <label class="text-gray-700 dark:text-gray-200">
                <input type="checkbox" value="Fire Alarm" v-model="isolation" />
                Fire Alarm
              </label>
            </div>
    ...
    submitForm() {
      ...
      let combinedFormData = {
        ...
        hotWork: {
          ...
          hotWorkBy: "",
          checkedHotWork: "null",
          checkedFireWatch: "null",
          checkedSafetyManager: "null",
          fireMonitorFinishTime: "null",
          fireMonitorCheckName: "null",
