<template>
  <main class="flex-1 overflow-x-hidden text overflow-y-auto bg-[#CED1DA] dark:bg-[#111827] p-4 sm:ml-64 h-screen">
    <div class="container mx-auto">
      <div
        ...
        <div class="pt-0 container px-6 py-10 mx-auto ">
          <div class="grid grid-cols-1 gap-8 mt-8 xl:mt-12 xl:gap-12 md:grid-cols-2 xl:grid-cols-3">
            <div class="p-6 space-y-3  h-20 border-4 bg-gray-200 dark:bg-gray-900 dark:border-gray-700 rounded-xl relative">


              <h1 class="text-xl font-semibold text-gray-700 capitalize dark:text-slate-300">On-Going Request</h1>
              ...
              <a href="#"
                ...
                <span class="text-blue-700 dark:text-white mx-1 top-5 font-semibold text-2xl absolute">3</span>
              </a>
            </div>
            ...
            <div class="p-6 space-y-3  h-20 border-4 bg-gray-200 dark:bg-gray-900 dark:border-gray-700 rounded-xl relative">
              ...
              <h1 class="text-xl font-semibold text-gray-700 capitalize ddark:text-slate-300"></h1>
            ...
            <div class="p-6 space-y-3  h-20 border-4 bg-tranparent dark:border-gray-700 dark:bg-gray-900 rounded-xl relative">


              <h1 class="text-xl font-semibold text-gray-700 capitalize dark:text-slate-300">New Request</h1>
      ...
      <div
        ...
        <section class="container px-4 mx-auto">
          <div class="flex items-center gap-x-3">
            <h2 class="text-lg font-medium text-gray-800 dark:text-white">My Request</h2>

            <span class="px-3 py-1 text-xs text-blue-600 bg-blue-100 rounded-full dark:bg-gray-800 dark:text-blue-400">34
              </span>
          </div>
                  ...
                  <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200 dark:divide-gray-700 dark:bg-gray-900">
                      <tr>
                        ...
                        <td class="px-4 py-4 text-sm text-gray-500 dark:text-gray-300 whitespace-nowrap">Design Director
                        </td>
                      ...
                      <tr>
                        ...
                        <td class="px-4 py-4 text-sm text-gray-500 dark:text-gray-300 whitespace-nowrap">Lead Developer
                        </td>
                        <td class="px-4 py-4 text-sm text-gray-500 dark:text-gray-300 whitespace-nowrap">
                          Incident Report</td>
                      ...
                      <tr>
                        <td class="px-4 py-4 text-sm font-medium text-gray-700 whitespace-nowrap">
                          <div class="inline-flex items-center gap-x-3">
                            ...
                            <div class="flex items-center gap-x-2">
                              ...
                              <div>
                                <h2 class="font-medium text-gray-800 dark:text-white ">Arthur Melo</h2>
                                <p class="text-sm font-normal text-gray-600 dark:text-gray-400">Arthur Melo</p>
                              </div>
                            </div>
                          </div>
                        </td>
                        ...
                        <td class="px-4 py-4 text-sm text-gray-500 dark:text-gray-300 whitespace-nowrap">Products Managers
                        </td>
                        <td class="px-4 py-4 text-sm text-gray-500 dark:text-gray-300 whitespace-nowrap">
                          Badge Request</td>
