            ...
            <tbody>
              <tr class="justify-centre text-center">
                <td class="border-gray-600 px-4 py-2">
                  <div
                    :class="
                      getStatusContainerClass(getRequest.safetyAdminStatus)
                    "
                  >
                    <span
                      :class="getStatusDotClass(getRequest.safetyAdminStatus)"
                    ></span>
                    <h2
                      :class="
                        getStatusTextClass(getRequest.safetyAdminStatus)
                      "
                    >
                      {{ getRequest.safetyAdminStatus }}
                    </h2>
                  </div>
                </td>
                <td class="border-gray-600 px-4 py-2">
                  {{ getRequest.safetyAdminComment }}
                </td>
                <td class="border-gray-600 px-4 py-2">
                  {{ getRequest.safetyModifiedBy }}
                </td>
              </tr>
            </tbody>
          </table>
