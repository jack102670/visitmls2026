  ...
  <transition name="slide-in">
    <div class="mobile-sidebar" :style="{ transform: dataOpenSideBar ? 'translateX(0)' : 'translateX(-100%)' }">
      ...
      <div class="flex flex-col justify-start bg-primary overflow-y-auto py-8 px-4">
        <div class="py-3 px-2 border-2 border-primary hover:bg-[#2d2169] rounded-md hover:border-2 ">
          <router-link to="/firsttimelogin" class="px-2 flex " @click="closeSidebarAndRequestForm">
        ...
        <div class="py-3 px-2 border-2 border-primary rounded-md hover:bg-[#2d2169] hover:border-2 ">
          <router-link to="/e-dashboard" class="px-2 flex " @click="closeSidebarAndRequestForm">
            <div class="flex space-x-4 w-full dropdown-transition">
        ...
        <div
          class="py-3 px-2 border-2 border-primary rounded-md cursor-pointer text-white  hover:border-2   hover:bg-[#2d2169]">
          <div class="px-2 flex justify-between items-center" @click="toggleRequestDropdown">
            <div class="flex space-x-2 justify-between items-center dropdown-transition">
              <font-awesome-icon :icon="['fas', 'grip-horizontal']" v-tooltip.right="'Request Form'"
                :style="{ color: '#ffffff', fontSize: '20px' }" />
              <span class="text-white ">Request Form</span>
            </div>
          ...
          <div class="mx-5">
            <transition name="slide-fade">
              <div v-show="dropdownOpen" class=" space-y-4 text-white dropdown-content">
        ...
        <div class="py-3 px-2 border-2 border-primary rounded-md hover:bg-[#2d2169] hover:border-2 ">
          <router-link to="/verify-request" class="px-2 flex " @click="closeSidebarAndRequestForm">
            <div class="flex space-x-4 w-full dropdown-transition">
