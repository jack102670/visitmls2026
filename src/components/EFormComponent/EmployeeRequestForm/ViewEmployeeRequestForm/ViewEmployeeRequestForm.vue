    ...
    <div class="space-y-4 border border-[1px] rounded-md shadow-sm px-4 py-2">
                ...
                <div class="grid grid-cols-1 gap-4">
                    ...
                    <div>
                        <label for="name" class="block mb-2 text-sm font-semibold text-primary dark:text-white">Name of
                            Employee: </label>
                        <div>
                            <p class="text-sm">{{ EmployeeTransfer.name }}</p>
                        </div>
                    </div>

                    <div>
                        <label for="company" class="block mb-2 text-sm font-semibold text-primary dark:text-white">Name
                            of
                            Company: </label>
                        <div>
                            <p class="text-sm">{{ EmployeeTransfer.company }}</p>
                        </div>
                    ...
                    <div>
                        ...
                        <div>
                            <p class="text-sm">{{ EmployeeTransfer.highestQualification }}</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="grid grid-cols-1 gap-4">
                    ...
                    <div>
                        <label for="designation"
                            class="block mb-2 text-sm font-semibold text-primary dark:text-white">Current
                            Designation: </label>
                        <div>
                            <p class="text-sm">{{ EmployeeTransfer.designation }}</p>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div>
                            <p class="text-sm">{{ EmployeeTransfer.department }}</p>
                        </div>
                    </div>
                    <div class="space-y-2">
                        ...
                        <div>
                            <p class="text-sm">{{ EmployeeTransfer.commencementDate }}</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div class="sm:pr-4 sm:border-r pr-4 sm:border-gray-300">
                <div class="grid grid-cols-1 gap-4">
                    <div>
                        ...
                        <div>
                            <p class="text-sm">{{ EmployeeTransfer.positionInterested }}</p>
                        </div>
                    </div>
                    <div>
                        <label for="workExp" class="block mb-2 text-sm font-semibold text-primary dark:text-white ">
                            ...
                            elaborate:</label>
                        <div>
                            <p class="text-sm">{{ EmployeeTransfer.workExp }}</p>
                        </div>
                    </div>
                </div>
            ...
            <div class="pl-4">
                <div class="grid grid-cols-1 gap-4">
                    <div>
                        <label for="transferDept"
                            class="block mb-2 text-sm font-semibold text-primary dark:text-white ">
                            Department </label>
                        <div>
                            <p class="text-sm">{{ EmployeeTransfer.transferDept }}</p>
                        </div>
                    ...
                    <div>
                        ...
                        <div>
                            <p class="text-sm">{{ EmployeeTransfer.transferReason }}</p>
                        </div>
                    </div>
