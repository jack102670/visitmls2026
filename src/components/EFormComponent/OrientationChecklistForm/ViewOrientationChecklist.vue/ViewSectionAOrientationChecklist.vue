          ...
          <div>
            ...
            <div class="flex flex-wrap gap-4 ">
              <div class="flex items-center">
                  <div v-if="EmployeeForm.hod.hoD_Emp_Email === '1'">
                    <label for="email" class=" text-sm font-medium text-gray-900 dark:text-gray-300">Email</label>
                  </div>    
              </div>
              <div class="flex items-center">
                <div v-if="EmployeeForm.hod.hoD_Emp_NameCard === '1'">
                    <label for="nameCards" class=" text-sm font-medium text-gray-900 dark:text-gray-300">Name Card</label>
                </div>
              </div>
              <div class="flex items-center">
                <div v-if="EmployeeForm.hod.hoD_Emp_Desktop === '1'">
                    <label for="desktop" class=" text-sm font-medium text-gray-900 dark:text-gray-300">Desktop</label>
                </div>
              </div>
              <div class="flex items-center"> 
                <div v-if="EmployeeForm.hod.hoD_Emp_Laptop === '1'">
                    <label for="laptop" class=" text-sm font-medium text-gray-900 dark:text-gray-300">Laptop</label>
                </div>
              </div>
            </div>
          </div>
