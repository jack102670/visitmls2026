  ...
  <div class="border border-[1px] rounded-md px-4 py-6 sm:px-6">
    ...
    <div class="space-y-4">
      <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
        <div>
          <label
            for="company"
            class="block mb-1 text-sm font-medium text-primary dark:text-white"
          >
          ...
          <input
            ...
            readonly
          />
          <span v-if="validationErrors.company" class="text-red-500 text-sm"
        ...
        <div>
          ...
          <input
            ...
            readonly
          />
          <span v-if="validationErrors.department" class="text-red-500 text-sm"
            >Please fill in this field.</span
          >
        </div>
      </div>
      ...
      <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
        <div>
          ...
          <input
            ...
            readonly
          />
          <span v-if="validationErrors.position" class="text-red-500 text-sm"
            >Please fill in this field.</span
          >
        </div>
        <div>
          ...
          <input
            ...
            readonly
          />
          <span v-if="validationErrors.reportTo" class="text-red-500 text-sm"
            >Please fill in this field.</span
          >
        </div>
      </div>
    ...
    <div class="">
      <label
        ...
        class="block mb-1 text-sm font-medium text-primary dark:text-white italic"
      >
      ...
      <textarea
        ...
        class="w-full bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
        placeholder="Write the responsibilities here"
        required
      ></textarea>
      <span
        v-if="validationErrors.responsibilities"
    ...
    <div class="">
      ...
      <textarea
        ...
        v-model="form.duties"
        class="w-full bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
        placeholder="Write the duties here"
        required
      ></textarea>
      <span v-if="validationErrors.duties" class="text-red-500 text-sm"
        >Please fill in this field.</span
      >
    </div>
    ...
    <div class="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-6">
      <div>
        ...
        <input
          ...
          required
        />
        <span v-if="validationErrors.education" class="text-red-500 text-sm"
          >Please fill in this field.</span
        >
      </div>
      <div>
        ...
        <input
          ...
          required
        />
        <span v-if="validationErrors.experience" class="text-red-500 text-sm"
          >Please fill in this field.</span
        >
      </div>
      <div>
        ...
        <input
          ...
          required
        />
        <span v-if="validationErrors.skills" class="text-red-500 text-sm"
          >Please fill in this field.</span
        >
      </div>
    </div>
