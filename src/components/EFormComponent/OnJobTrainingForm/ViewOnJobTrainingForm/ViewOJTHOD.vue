    ...
    <div class="space-y-6  pb-4 px-6">
        <div v-if="status !== 'Completed by Superior. Waiting for HR'">
            <div>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div class="">
                        ...
                        <span class="text-red-500 text-sm" v-if="validationErrors.achieveTarget">Please fill in this
                            field</span>
                    </div>
                    ...
                    <div class="">
                        ...
                        <span class="text-red-500 text-sm" v-if="validationErrors.verify">Please fill in this
                            field"</span>
                    </div>
                </div>
            ...
            <div class="grid grid-cols-8 space-x-2 mt-4">
                <div class="col-span-8 flex justify-end">
                    ...
                    <button @click.prevent="UpdateOJT(refNo)"
        ...
        <div v-if="status === 'Completed by Superior. Waiting for HR'">
            ...
            <h1 class="font-bold text-md py-2">
                Head of Department Verification
            </h1>
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div class="">
                    <label for="basicSalary" class="block mb-2 text-sm font-semibold text-primary dark:text-white">
...
<script>
import { UpdateOJT, fetchHrData, getOnJobTraining } from '@/api/EFormApi';
...
export default {
    ...
    mounted() {
        ...
        if (this.refNo) {
            this.getOnJobTraining(this.refNo);
        }
        this.fetchHrData();
    },
    computed: {
        formattedHodDate() {
            if (this.DisplayForm.hodDate) {
                const date = new Date(this.DisplayForm.hodDate);
        ...
        async UpdateOJT(refNo) {
            if (!this.verifyStatus) {
                    Swal.fire({
                        ...
                        text: 'Please verify the Trainer Acknowledgement before submitting.',
                        icon: 'warning',
                        confirmButtonColor: '#3085d6',
