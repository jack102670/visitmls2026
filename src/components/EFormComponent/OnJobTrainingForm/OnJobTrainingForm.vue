        ...
        <div class="space-y-6 border-[1px] rounded-md py-4 px-6">
            <div class="grid grid-cols-8 gap-2">
                ...
                <div class="col-span-3">
                    <label for="position"
                        class="block text-sm font-medium text-primary dark:text-white">{{ user.name }}</label>
                </div>
                <div class="col-span-1">
                </div>
                <div class="col-span-3 flex space-x-6">
                    ...
                    <label for="position"
                        class="block text-sm font-medium text-primary dark:text-white">Familiriarisation
                        Programme</label>
                </div>
                <div class="col-span-1">
