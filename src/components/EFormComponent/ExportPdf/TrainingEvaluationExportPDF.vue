                  ...
                  [
                    ...
                    },
                    {
                      table: {
                        ...
                        body: [
                          [
                            { text: 'Skills [   ]', fontSize: 10, alignment: 'center' },
                            { text: 'Knowledge [   ]', fontSize: 10, alignment: 'center' },
                            { text: 'Refresher [   ]', fontSize: 10, alignment: 'center' }
                          ]
                        ]
                      },
                      layout: 'noBorders'
    ...
    ,
    {
      ...
      table: {
        ...
        body: [
          ...
          [
            { text: '4. Test result (if any)', fontSize: 10, alignment: 'left', border: [true, true, true, true] },
            { text: '', fontSize: 10, alignment: 'center', border: [true, true, true, true] },
            { text: '', fontSize: 10, alignment: 'center', border: [true, true, true, true] },
            { text: '', fontSize: 10, alignment: 'center', border: [true, true, true, true] },
            { text: '', fontSize: 10, alignment: 'center', border: [true, true, true, true] }
