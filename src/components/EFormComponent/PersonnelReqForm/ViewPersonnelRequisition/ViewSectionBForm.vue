                ...
                <div class="grid grid-cols-1 gap-4">
                    <div class="">
                        <div class="grid md:grid-cols-2 md:gap-4">
                            <div>
                                <label for="minAge"
                                    class="block mb-2 text-sm font-semibold text-primary dark:text-white">Min
                                    Age:</label>
                                <div>
                                    <p class="text-sm">{{ minAge || '-' }}</p>
                                </div>
                            </div>
                            <div>
                                <label for="maxAge"
                                    class="block mb-2 text-sm font-semibold text-primary dark:text-white">Max
                                    Age:</label>
                                <div>
                                    <p class="text-sm">{{ maxAge || '-' }}</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="flex flex-col sm:flex-row sm:items-start sm:space-x-4 w-full">
                        ...
                        <div class="flex-1 flex-col space-x-[1px]" v-if="form.expRequired === 'yes'">
                            ...
                            <div>
                                <p class="text-sm">{{ form.yearsRequired }}</p>
                            </div>
                        </div>
                    </div>
                    <div>
                        <label for="qualificationRequired"
                            class="block mb-2 text-sm font-semibold text-primary dark:text-white">Qualification
                            Required?: </label>
                        <div>
                            <p class="text-sm">
                    ...
                    <div>
                        ...
                        <div class="space-y-2">
                            ...
                            <div v-else class="flex flex-wrap gap-2 mb-2">
                                <div v-for="(discipline, index) in splitDiscipline(form.disciplineSpecification)"
                ...
                <div class="grid grid-cols-1 gap-4">
                    <div class="flex flex-col sm:flex-row sm:items-start sm:space-x-4 w-full">
                        ...
                        <div class="flex-1" v-if="form.computerLiteracyRequired === 'yes'">
                            ...
                            <div>
                                <p class="text-sm">{{ form.computerSpecification || '-' }}</p>
                            </div>
                        </div>
                    </div>
                    <div>
                        <label for="ownTransportRequired"
                            class="block mb-2 text-sm font-semibold text-primary dark:text-white">
                    ...
                    <div>
                        ...
                        <div class="space-y-2">
                            ...
                            <div v-else class="flex flex-wrap gap-2 mb-2">
                                <div v-for="(field, index) in form.jobCompetency" :key="index"
                    ...
                    <div>
                        ...
                        <div class="space-y-2">
                            ...
                            <div v-else class="flex flex-wrap gap-2 mb-2">
                                <div v-for="(field, index) in form.personalCompetency" :key="index"
                                    class="flex items-center">
                                    <span
