        ...
        <ul
            ...
            <li class="me-2" v-for="section in ['A', 'B', 'C', 'D']" :key="section">
                <a href="#" @click.prevent="changeSection(section)" :class="[
                    ...
                    currentSection === section ? 'text-white bg-primary dark:bg-gray-800 dark:text-blue-500' : 'hover:text-white bg-[#7293B3] text-white hover:bg-[#2d2169] dark:hover:bg-gray-800 dark:hover:text-gray-300',
                ]">
                    Section {{ section }}
                </a>
            </li>
