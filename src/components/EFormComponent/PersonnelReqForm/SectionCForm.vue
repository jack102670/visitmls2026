        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <div>
                ...
                <div class="flex space-x-4 items-center mb-4">
                    <input id="yes-employeeConfirmation" type="radio" value="yes" v-model="verifyForm.employeeConfirmation"
                    ...
                    <input id="no-employeeConfirmation" type="radio" value="no" v-model="verifyForm.employeeConfirmation"
                        class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
...
export default {
    ...
    methods: {
        ...
        validateForm() {
            ...
            if (!this.verifyForm.employeeConfirmation)
        ...
        handleSubmit() {
            if (this.verifyForm.employeeConfirmation !== "yes") {
                Swal.fire({
