<template>
    <div class="space-y-4 mt-2 border-[1px] rounded-md px-4 py-2">
        <h1 class="font-bold text-md py-2 dark:text-white">B. Person Specification</h1>
        <label for="ageLimit" class="block mb-2 text-sm font-medium text-primary dark:text-gray-300">Age Limit: <span
                class="text-red-500">*</span></label>
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div class="">
                <div class="grid md:grid-cols-2 md:gap-4">
                    <div>
                        <label for="minAge" class="block mb-2 text-sm font-medium text-primary dark:text-gray-400 italic">Min
                            Age:</label>
                        <input type="number" id="minAge" v-model="minAge"
            class="w-full bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 p-2.5 dark:bg-gray-500 dark:border-gray-400 dark:placeholder-gray-300 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                            placeholder="Input Min Age" required />
                    </div>
                    <div>
                        <label for="maxAge" class="block mb-2 text-sm font-medium text-primary dark:text-gray-400 italic">Max
                            Age:</label>
            ...
            <div class="flex flex-col sm:flex-row sm:items-start sm:space-x-4 w-full">
                <div class="flex-1">
                    <label for="computerLiteracyRequired"
                        class="block mb-2 text-sm font-medium text-primary dark:text-gray-300">
                    ...
                    <div class="flex space-x-4 items-center mt-2">
                        <div class="flex items-center space-x-2">
                            ...
                            <label for="yes-computerLiteracyRequired"
                                class="text-sm font-medium text-gray-900 dark:text-gray-400 italic">Yes</label>
                        </div>
                        <div class="flex items-center space-x-2">
                            ...
                            <label for="no-computerLiteracyRequired"
                                class="text-sm font-medium text-gray-900 dark:text-gray-400 italic">No</label>
                        </div>
                    </div>
                ...
                <div class="flex-1" v-if="form.computerLiteracyRequired === 'yes'">
                    <label for="computerSpecification"
                        class="block mb-2 text-sm font-medium text-primary dark:text-gray-400 italic">
            ...
            <div class="flex flex-col sm:flex-row sm:items-start sm:space-x-4 w-full">
                <div class="flex-1">
                    <label for="expRequired" class="block mb-2 text-sm font-medium text-primary dark:text-gray-300">
                    ...
                    <div class="flex space-x-4 items-center mt-2">
                        <div class="flex items-center space-x-2">
                            ...
                            <label for="yes-expRequired"
                                class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-400 italic">Yes</label>
                        </div>
                        <div class="flex items-center space-x-2">
                            <input id="no-expRequired" type="radio" value="no" v-model="form.expRequired"
                                class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600" />
                            <label for="no-expRequired"
                                class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-400 italic">No</label>
                        </div>
                    </div>
                ...
                <div class="flex-1 flex-col space-y-2 space-x-[1px]" v-if="form.expRequired === 'yes'">
                    <label for="yearsRequired" class="block text-sm font-medium text-primary dark:text-gray-400 italic">
            ...
            <div>
                <label for="ownTransportRequired" class="block mb-2 text-sm font-medium text-primary dark:text-gray-300">
            ...
            <div>
                <label for="qualificationRequired"
                    class="block mb-2 text-sm font-medium text-primary dark:text-gray-300">Qualification Required?: <span
                        class="text-red-500">*</span></label>
                <div class="flex space-x-4 items-center mb-4">
                    ...
                    <label for="spm-qualificationRequired"
                        class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-400 italic">SPM/SPVM/STPM</label>
                    ...
                    <label for="diploma-qualificationRequired"
                        class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-400 italic">DIPLOMA/DEGREE</label>
                </div>
                <span v-if="validationErrors.qualificationRequired" class="text-red-500 text-sm">Please fill in this
                    field</span>
            </div>
            <div>
                <label for="jobCompetency" class="block  text-sm font-medium text-primary dark:text-gray-300">
            ...
            class="w-full bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 p-2.5 dark:bg-gray-500 dark:border-gray-400 dark:placeholder-gray-300 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                        <div v-if="showDropdown && filteredDisciplines.length > 0"
                            class="absolute z-10 w-full mt-1 bg-white border border-gray-300 rounded-lg shadow-lg max-h-60 overflow-y-auto dark:bg-gray-500 dark:border-gray-400">
            ...
            <div>
                <label for="personalCompetency" class="block  text-sm font-medium text-primary dark:text-gray-300">
        ...
        <div class="grid grid-cols-1">
            <label for="others" class="block mb-2 text-sm font-medium text-primary dark:text-gray-400 italic">
