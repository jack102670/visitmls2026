    ...
    <div class="space-y-4 mt-2 border-[1px] rounded-md  px-4 py-2">
        ...
        <div class="grid grid-cols-8 gap-2">
            ...
            <div class="col-span-3">
                <input type="text" id="noofpersonnel"
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                    placeholder="Specify Requirement" required />
            </div>
        </div>
        <div class="grid grid-cols-8 gap-2">
            <div class="col-span-1">
            ...
            <div class="col-span-3">
                <input type="text" id="noofpersonnel"
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                    placeholder="Specify Years" required />
            </div>
            <div class="col-span-1">
                <label for="basicSalary" class="block mb-2 text-sm font-medium text-primary dark:text-white">
        ...
        <div class="grid grid-cols-8 gap-2">
            ...
            <div class="col-span-3">
                <input type="text" id="noofpersonnel"
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                    placeholder="Eg: Selling/Accounting/Debtors Control/IT/Management etc..." required />
            </div>
        </div>
        <div class="grid grid-cols-8 gap-2">
            <div class="col-span-1">
            ...
            <div class="col-span-3">
                <input type="text" id="noofpersonnel"
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                    placeholder="Specify discipline" required />
            </div>
            <div class="col-span-1">
                <label for="personnel" class="block mb-2 text-sm font-medium text-primary dark:text-white">
            ...
            <div class="col-span-3">
                <input type="text" id="noofpersonnel"
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                    placeholder="Eg: Leadership, Perserverance/Customer/ Driven/Interpersonal Skills etc..." required />
            </div>
