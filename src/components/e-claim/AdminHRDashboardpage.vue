                ...
                >
                  ...
                  >
                    <tr v-for="(claim, index) in paginatedApplications" :key="index">
                      <td class="text-wrap px-4 text-center font-medium py-4 text-sm text-gray-500 dark:text-gray-300 whitespace-nowrap">
...
export default {
  ...
  methods: {
    ...
    FetchClaimsData() {
      ...
      axios
        .get(
          'http://172.28.28.117:7165/api/ApproverVerifier/GetAllRequestApproverHR/'
        )
        .then((response) => {
